...
interface PROJRECTCARD  {
  imgUrl? : string , title? : string , description? : string , gitUrl? : string , previewUrl? : string
}

function ProjectsCard({ imgUrl, title, description , gitUrl , previewUrl} : PROJRECTCARD ) {
  return (
    <div>
      <div
